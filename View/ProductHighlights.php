                        ...
                        <div class="col-6 col-lg-3">
                            <div class="box">
                                <div class="box__add-to-card">
                                        <a href="?Action=ChiTietSanPham&Id=<?php echo $QuerySPCT['SPCT_Id'];?>">Them vao gio hang</a>
                                    </div>
                                    <div class="box__img">
                                        <a href="?Action=ChiTietSanPham&Id=<?php echo $QuerySPCT['SPCT_Id'];?>"><img src="/HT-Electronics/Public/ImageSPCT/<?php echo $QueryHinh['Full'];?>" class="d-block w-100" alt="new-product-1"></a>
                                    </div>
