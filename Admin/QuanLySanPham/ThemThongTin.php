...
?>                 
    <div class="container-fluid">
       <form action="?Action=ThemThongTinSanPham" method="post">
            ...
            <button class="btn btn-warning" type="submit" name="themthongtin" value="themThongTin">Thêm thông tin cho sản phẩm</button>
        </form>  
    </div>
    </div>
<!-- End of Main Content -->
