    ...
    <?php
        ...
        $message = "<html>
                    <body>
                        <h1>Mail From HT-Electronics shop - Đơn hàng bị từ chối</h1>
                        <p>Đơn hàng #". $DiaChi_Id . " của bạn không duyệt thành công</p>
                    </body>
                    </html>";
        $Mail =new PHPMailer();
        $GuiMail = new Admin();
        ...
        $Mail->Subject = 'Don Hang Cua Ban Chua Duoc Xac Nhan';
